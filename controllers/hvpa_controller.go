...
func updateEventFunc(e event.UpdateEvent) bool {
	...
	case *autoscalingv1alpha1.Hvpa, *autoscalingv2beta2.HorizontalPodAutoscaler, *vpa_api.VerticalPodAutoscaler:
...
func (r *HvpaReconciler) reconcileHpa(hvpa *autoscalingv1alpha1.Hvpa) (*autoscalingv2beta2.HorizontalPodAutoscalerStatus, error) {
	...
	// anymore but has the stale controller ref.
	hpas := &autoscalingv2beta2.HorizontalPodAutoscalerList{}
...
func (r *HvpaReconciler) scaleIfRequired(hpaStatus *autoscalingv2beta2.HorizontalPodAutoscalerStatus,
	vpaStatus *vpa_api.VerticalPodAutoscalerStatus,
	hvpa *autoscalingv1alpha1.Hvpa,
	target runtime.Object,
) (*autoscalingv2beta2.HorizontalPodAutoscalerStatus,
...
func getWeightedReplicas(hpaStatus *autoscalingv2beta2.HorizontalPodAutoscalerStatus, hvpa *autoscalingv1alpha1.Hvpa, currentReplicas int32, hpaWeight int32, blockedScaling *[]*autoscalingv1alpha1.BlockedScaling) (*autoscalingv2beta2.HorizontalPodAutoscalerStatus, error) {
	...
	outHpaStatus := &autoscalingv2beta2.HorizontalPodAutoscalerStatus{
...
func isHpaScaleOutLimited(hpaStatus *autoscalingv2beta2.HorizontalPodAutoscalerStatus, maxReplicas int32, hpaScaleUpUpdateMode *string, maintenanceWindow *autoscalingv1alpha1.MaintenanceTimeWindow) bool {
	...
	for _, v := range hpaStatus.Conditions {
		if v.Type == autoscalingv2beta2.ScalingLimited && v.Status == corev1.ConditionTrue {
