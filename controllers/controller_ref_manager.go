...
func (m *HvpaControllerRefManager) ClaimHpas(hpas *autoscalingv2.HorizontalPodAutoscalerList, filters ...func(*autoscalingv2.HorizontalPodAutoscaler) bool) ([]*autoscalingv2.HorizontalPodAutoscaler, error) {
	...
	adopt := func(obj metav1.Object) error {
		return m.AdoptHpa(obj.(*autoscalingv2.HorizontalPodAutoscaler))
	}
	release := func(obj metav1.Object) error {
		return m.ReleaseHpa(obj.(*autoscalingv2.HorizontalPodAutoscaler))
	}
...
// the patching fails.
func (m *HvpaControllerRefManager) AdoptHpa(hpa *autoscalingv2.HorizontalPodAutoscaler) error {
...
func (m *HvpaControllerRefManager) ReleaseHpa(hpa *autoscalingv2.HorizontalPodAutoscaler) error {
