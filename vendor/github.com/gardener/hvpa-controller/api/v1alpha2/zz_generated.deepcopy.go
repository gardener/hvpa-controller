...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ScaleInterval) DeepCopyInto(out *ScaleInterval) {
	*out = *in
	if in.MaxCPU != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ScaleInterval.
func (in *ScaleInterval) DeepCopy() *ScaleInterval {
	if in == nil {
		return nil
	}
	out := new(ScaleInterval)
	in.DeepCopyInto(out)
	return out
}
