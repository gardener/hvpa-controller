...
func TestReconcile(t *testing.T) {
	...
	instance := &autoscalingv1alpha1.Hvpa{ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "default"}}
	...
	// Create the Hvpa object and expect the Reconcile and Deployment to be created
