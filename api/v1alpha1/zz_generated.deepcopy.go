...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EffectiveScalingInterval) DeepCopyInto(out *EffectiveScalingInterval) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EffectiveScalingInterval.
func (in *EffectiveScalingInterval) DeepCopy() *EffectiveScalingInterval {
	if in == nil {
		return nil
	}
	out := new(EffectiveScalingInterval)
	in.DeepCopyInto(out)
	return out
}
...
func (in *HvpaSpec) DeepCopyInto(out *HvpaSpec) {
	*out = *in
	...
	if in.BaseResourcesPerReplica != nil {
		in, out := &in.BaseResourcesPerReplica, &out.BaseResourcesPerReplica
		*out = make(ResourceChangeParams, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
	...
	if in.ScalingIntervalsOverlap != nil {
		in, out := &in.ScalingIntervalsOverlap, &out.ScalingIntervalsOverlap
		*out = make(ResourceChangeParams, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ResourceChangeParams) DeepCopyInto(out *ResourceChangeParams) {
	{
		in := &in
		*out = make(ResourceChangeParams, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResourceChangeParams.
func (in ResourceChangeParams) DeepCopy() ResourceChangeParams {
	if in == nil {
		return nil
	}
	out := new(ResourceChangeParams)
	in.DeepCopyInto(out)
	return *out
}
...
func (in *ScaleIntervals) DeepCopyInto(out *ScaleIntervals) {
	*out = *in
	if in.EffectiveIntervalExtrapolation != nil {
		in, out := &in.EffectiveIntervalExtrapolation, &out.EffectiveIntervalExtrapolation
		*out = new(EffectiveIntervalExtrapolationType)
		**out = **in
	}
}
