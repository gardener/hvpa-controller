...
// +kubebuilder:webhook:path=/mutate-autoscaling-k8s-io-v1alpha2-hvpa,mutating=true,failurePolicy=fail,groups=autoscaling.gardener.cloud,resources=hvpas,verbs=create;update,versions=v1alpha2,name=mhvpa.kb.io
...
// +kubebuilder:webhook:path=/validate-autoscaling-k8s-io-v1alpha2-hvpa,mutating=false,failurePolicy=fail,groups=autoscaling.gardener.cloud,resources=hvpas,verbs=create;update,versions=v1alpha2,name=vhvpa.kb.io
